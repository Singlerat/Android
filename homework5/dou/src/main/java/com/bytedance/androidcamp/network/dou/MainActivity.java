...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("18888912236", "kjs", coverImagePart, videoPart).enqueue(
        ...
        miniDouyinService.getVideos().enqueue(new Callback<GetVideosResponse>() {
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    {
                        mVideos.clear();
                        for(Video i: response.body().videos)
                        {
                            if(i.studentId.equals("18888912236")&&i.userName.equals("kjs"))
                            {
                                mVideos.add(i);
                            }
